...
:::tip
Bots are managed just like regular Clan members. You can review and adjust their permissions and roles the same way — through [**Role and Permission Management**.](../clan/create-your-own-clan/manage-clan/overview-settings/roles-and-permissions-management)
:::