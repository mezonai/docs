...
<Steps>
<Step title="Click your **Clan name**, then select **Create Category**. Make sure **Show Empty Category** is enabled.">
<Image style={{ margin: '1rem 2rem' }}  src={clanCategory001} alt="Clan Category 001" />
</Step>
<Step title="Enter the **Category name** you want and click **Create Category**.">
<Image style={{ margin: '1rem 2rem' }}  src={clanCategory002} alt="Clan Category 002" />
</Step>
<Step title="The new Category will appear on the left-hand navigation panel.">
<Image style={{ margin: '1rem 2rem' }}  src={clanCategory003} alt="Clan Category 003" />
</Step>
<Step title="You can move channels between Categories by **dragging and dropping** them into the desired position."></Step>
</Steps>
:::tip
...
<Heading as="h3">How to Manage a Category</Heading>
