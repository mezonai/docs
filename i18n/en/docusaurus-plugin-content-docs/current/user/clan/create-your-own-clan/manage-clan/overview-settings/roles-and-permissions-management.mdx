...
:::info
However, the **Manage Clan** permission <span style={{color: "var(--ifm-color-danger)"}}>**cannot view or manage the full channel list**</span>, which distinguishes it from **Administrator**.
:::
...
<Steps>
<Step title="In the left menu, select **Roles**.">
<Image style={{ margin: '1rem 2rem' }} src={rolesAndPermissionsManagement002}></Image>
</Step>

<Step title="Under **Default Permissions**, set the basic actions that all members in the Clan can perform.">
<Image style={{ margin: '1rem 2rem' }} src={rolesAndPermissionsManagement003}></Image>
</Step>

<Step title="Choose the permissions you want to apply to everyone and click **Save Changes**.">
...
<Step title="Click **Create Role**, then edit the **name, color, and icon** under **Displays**.">
...
<Step title="Under **Manage Members**, click **Add Members** to assign members to the **Role**.">
...
<Step title="In **Permissions**, customize what actions the role can perform (e.g., Admin, Send Message, Delete Message, etc.).">

<Image style={{ margin: '1rem 2rem' }} src={rolesAndPermissionsManagement008}></Image>
</Step>
<Step title="Click **Save Changes** to apply the role settings.">
</Step>

<Step title="Changing Role Display Order.">
...
<Heading as="h3">1. Permissions Management</Heading>
...
<Heading as="h4">1.1. Available Permissions</Heading>
...
<Heading as="h4">1.2. Setting Default Permissions</Heading>
...
<Heading as="h3">2. Roles Management</Heading>
...
<Heading as="h4">2.1. Creating a New Role</Heading>
...
<Heading as="h4">2.2. Managing Existing Roles</Heading>
...
<Heading as="h3">3. Permission Overrides</Heading>
...
<Heading as="h4">Customizing Permissions in Private Channels/Threads</Heading>
