...
2. Go to **For You** to view notifications such as friend requests or Mezon Coins sent to you.

<Image style={{ margin: '1rem 2rem' }}  src={inbox002} alt="Inbox 002" />

3. Go to **Messages** to see messages you’ve added or important messages from the Clan.
