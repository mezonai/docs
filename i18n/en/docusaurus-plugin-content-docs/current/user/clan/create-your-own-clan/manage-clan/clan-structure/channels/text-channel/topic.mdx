...
<Steps>
<Step title="In a **Text Channel** or **Thread**, right-click the message you want to discuss."></Step>
<Step title="Select **Topic Discussion**">
<Image style={{ margin: '1rem 2rem' }}  src={topic001} alt="Topic 001" />
</Step>
<Step title="Enter your message in the **Topic window** on the right to start the discussion.">
...
<Heading as="h3">How to review Topics you've participated in</Heading>
