...
<Image style={{ margin: '1rem 2rem' }} src={shortcuts009}></Image>

<Image style={{ margin: '1rem 2rem' }} src={shortcuts010}></Image>
:::
...
<Heading as="h4">How to disable:</Heading>
...
<Heading as="h3">Message Formatting</Heading>

<Heading as="h4">Large Text</Heading>
...
<Heading as="h4">Code Block</Heading>
