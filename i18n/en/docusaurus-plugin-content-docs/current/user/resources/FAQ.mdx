...
17. **Can I use bots in Mezon?**\
    Yes. Mezon supports bots and apps. You can add bots to manage your Clan, play music, or provide other utilities. Explore bots on the [**Bots/Apps page**](https://top.mezon.ai/) or create your own using the [**Mezon SDK**](https://mezon.ai/docs/mezon-sdk-docs/).
