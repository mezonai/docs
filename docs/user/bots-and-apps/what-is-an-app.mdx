...
Tìm hiểu cách xây dựng và tích hợp App tại [**Mezon Developer Docs**](/developer/mezon-sdk/channel-app-sdk).\
...
[**Mezon Developer Docs**](/developer/mezon-sdk/channel-app-sdk) | [**Mezon Discover**](https://top.mezon.ai/)