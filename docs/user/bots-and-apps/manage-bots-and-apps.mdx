...
### Xem & Điều chỉnh
Truy cập phần Thành viên trong Clan của bạn. Tại đây, bạn sẽ thấy danh sách tất cả các Bot và App đang hoạt động.

![manage-bots-and-apps-001](./images/manage-bots-and-apps-001.png)

### Tùy chỉnh vai trò và quyền hạn
Tương tự như thành viên thông thường, bạn có thể thiết lập vai trò cụ thể cho Bot/App. Điều này giúp bạn kiểm soát chặt chẽ các hành động mà chúng có thể thực hiện trong Clan. Điều chỉnh quyền hạn trong **Cài đặt Clan > Vai trò**.

![manage-bots-and-apps-002](./images/manage-bots-and-apps-002.png)

### Quản lý nâng cao
Nhấp vào Bot/App để xem Profile của chúng. Từ đây, bạn có thể gửi tin nhắn trực tiếp, chuyển quyền sở hữu (đối với Bot/App do bạn phát triển), hoặc gỡ Bot/App ra khỏi Clan nếu không còn nhu cầu sử dụng.
