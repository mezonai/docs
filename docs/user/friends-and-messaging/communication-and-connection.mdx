...
* **Tìm kiếm:** Tìm kiếm tin nhắn trong cuộc trò chuyện. Một số tùy chọn tìm kiếm nâng cao có thể tham khảo tại: [**Tìm kiếm**](../clan/create-your-own-clan/manage-clan/clan-structure/channels/text-channel/search).
