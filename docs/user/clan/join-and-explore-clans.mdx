...
import joinAndExploreClans001 from './images/join-and-explore-clans-001.png';
import joinAndExploreClans002 from './images/join-and-explore-clans-002.png';


# Tham gia & Khám phá Clan
Cách tìm, tham gia hoặc rời khỏi một Clan có sẵn.

### Cách tham gia một Clan

Bạn có thể khám phá Clan mới theo 2 cách:

1. **Nút Khám phá** ![join-and-explore-clans-001](./images/join-and-explore-clans-001.png) trong ứng dụng hoặc khám phá trực tiếp qua [**Website Clans**](https://mezon.ai/clans/): Nơi tổng hợp thông tin của tất cả Clan sôi nổi nhất của Mezon.
