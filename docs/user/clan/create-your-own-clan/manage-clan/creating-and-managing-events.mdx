...
import creatingAndManagingEvents006 from "./images/creating-and-managing-events-006.png";
...
<Steps>
<Step title="Ở thanh điều hướng bên trái, chọn **Sự kiện**.">
...
<Image style={{ margin: '1rem 2rem' }} src={creatingAndManagingEvents006} alt="creating-and-managing-events-006" />
</Step>
</Steps>
</TabItem>
<TabItem value="mobile" label="Mobile">
<Heading as="h3">Cách tạo Sự kiện</Heading>
