...
<Image style={{ margin: '1rem 2rem' }} src={emojiImageAndVoiceStickers003}></Image>
...
<Image style={{ margin: '1rem 2rem' }} src={emojiImageAndVoiceStickers004}></Image>
...
<Image style={{ margin: '1rem 2rem' }} src={emojiImageAndVoiceStickers005}></Image>
...
<Heading as="h3">Cách thêm Biểu tượng cảm xúc & Nhãn dán hình ảnh & Nhãn dán âm thanh</Heading>
