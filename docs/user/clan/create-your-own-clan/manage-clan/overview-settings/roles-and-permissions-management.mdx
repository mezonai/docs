...
<Heading as="h3">1. Quản lý quyền hạn</Heading>

Khi cộng đồng phát triển, số lượng thành viên tham gia và mức độ tương tác ngày càng lớn. Nếu không kiểm soát được quyền hạn, rất dễ xảy ra tình trạng spam tin nhắn, xóa nội dung quan trọng hoặc chỉnh sửa kênh ngoài ý muốn. Điều này không chỉ gây mất trật tự mà còn ảnh hưởng đến trải nghiệm chung của cả nhóm.

<Heading as="h4">1.1. Các quyền hiện có trong hệ thống</Heading>
...
<Heading as="h4">Phân biệt các quyền trong Clan</Heading>
...
<Heading as="h4">1.2. Cách thiết lập quyền mặc định</Heading>
...
<Heading as="h3">2. Quản lý vai trò</Heading>
...
<Heading as="h4">**2.1. Cách tạo vai trò mới**</Heading>
...
<Heading as="h4">2.2. Quản lý vai trò đã tạo</Heading>
...
<Heading as="h3">3. Ghi đè quyền hạn</Heading>
...
<Heading as="h4">**Cách tùy chỉnh chi tiết quyền trong kênh/ chủ đề riêng tư**</Heading>
