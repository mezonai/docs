...
:::info
Tuy nhiên quyền **Manage Clan** <mark style={{backgroundColor: "$danger"}}>**không nhìn thấy và không quản lý được toàn bộ danh sách kênh**</mark>, điểm này khác biệt so với Administrator.
:::
...
![roles-and-permissions-management-012](./images/roles-and-permissions-management-012.png)
