...
<img style={{ width: '40%' }} src={managingNotificationsInAClan001} alt="managing-notifications-in-a-clan-001" />
...
<img style={{ width: '50%' }} src={managingNotificationsInAClan002} alt="managing-notifications-in-a-clan-002" />
