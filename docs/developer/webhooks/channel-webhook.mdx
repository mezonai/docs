...
| `hg`       | array of objects | No       | An array of objects, each representing a channel hashtag mentioned in the message.                                                                                                                                                                               |
...
| Field      | Type    | Required | Description                                                    |
| ---------- | ------- | -------- | -------------------------------------------------------------- |
| `username` | string  | No       | The username of the mentioned user.                            |
| `user_id`  | string  | No       | The unique identifier of the mentioned user.                   |
...
:::tip TIPS
You can mention everyone in the channel in two ways:
- **By user_id**: Use the unique identifier **`1775731111020111321`** to mention to everyone in the channel
- **By username**: Use **`here`** as the username to mention everyone in the channel (@here)

Either `username` or `user_id` must be provided, but not both.
:::

**Example 1: Mention @here by user_id**
...
**Example 2: Mention @here by username**
...
| Field       | Type    | Required | Description                                                           |
| ----------- | ------- | -------- | --------------------------------------------------------------------- |
| `channelId` | string  | Yes      | The unique identifier of the channel being referenced.                |
| `s`         | integer | Yes      | The starting character index of the hashtag in the `t` string.        |
| `e`         | integer | Yes      | The ending character index of the hashtag in the `t` string.          |
